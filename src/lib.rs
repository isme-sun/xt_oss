...
use crate::models::ListAllMyBucketsResult;
use crate::{
    arguments::{DescribeRegionsQuery, ListBucketsQuery, ListObject2Query, OSSQuery},
    models::{
        BucketInfo, BucketStat, ListBucketResult, ListCnameResult, RegionInfo, RegionInfoList,
    }
};
